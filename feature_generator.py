...
def feature_creator(data_frame):
    ...
    #monday = data_frame.apply(which_day, args=([1]),axis=1)
    #tuesday = data_frame.apply(which_day, args=([2]),axis=1)
    #wednesday = data_frame.apply(which_day, args=([3]),axis=1)
    #thursday = data_frame.apply(which_day, args=([4]),axis=1)
    #friday = data_frame.apply(which_day, args=([5]),axis=1)
    manager = data_frame.apply(manager_in_meeting, axis =1)
    ...
    #feature_df["monday"] = monday
    #feature_df["tuesday"] = tuesday
    #feature_df["wednesday"] = wednesday
    #feature_df["thursday"] = thursday
    #feature_df["friday"] = friday
